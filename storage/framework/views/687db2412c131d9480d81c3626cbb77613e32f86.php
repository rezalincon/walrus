                ...
                <?php if(Auth::user()->role_id == '1' or Auth::user()->role_id == '2'): ?>
                    ...
                    <li class="<?php echo e(Request::is('admin/setting/logo', 'admin/setting/footer', 'admin/setting/favicon', 'admin/setting/shipping', 'admin/setting/headerText', 'admin/setting/view-submenu', 'admin/social/topmenu/view' ) ? 'active' : ''); ?>">
                        ...
                        <ul class="metismenu">
                            ...
                            <li class="<?php echo e(Request::is('admin/setting/headerText') ? 'active' : ''); ?>"><a href="<?php echo e(route('header.text')); ?>">Header Text</a></li>
                            <li class="<?php echo e(Request::is('admin/setting/view-submenu') ? 'active' : ''); ?>"><a href="<?php echo e(route('view_sub_menu')); ?>">Footer Menu</a></li>
                            <li class="<?php echo e(Request::is('admin/social/topmenu/view') ? 'active' : ''); ?>"><a href="<?php echo e(route('topmenu.view')); ?>">Top Menu</a></li> 
                            
                            <li class="<?php echo e(Request::is('admin/terms-condition') ? 'active' : ''); ?>"><a href="<?php echo e(route('setting.terms')); ?>">Terms And Conditions</a></li>
                    ...
                    <li class="<?php echo e(Request::is('admin/setting/campaign', 'admin/setting/services', 'admin/setting/sliders', 'admin/setting/advertise') ? 'active' : ''); ?>">
                        ...
                        <ul class="metismenu">
                            ...
                            <li class="<?php echo e(Request::is('admin/setting/advertise') ? 'active' : ''); ?>"><a href="<?php echo e(route('advertise.view')); ?>">Advertisements</a></li>
                        </ul>
                    </li>
...
<?php /**PATH /home/aayancom/public_html/resources/views/admin/layout/header/left-sidebar.blade.php ENDPATH**/ ?>