...
<script src="<?php echo e(asset('/backend/assets/vendor/summernote/dist/summernote-bs4.min.js')); ?>"></script>
<script src="<?php echo e(asset('/backend/js/pages/ui/dialogs.js')); ?>"></script>
<script src="<?php echo e(asset('/vendor/js/vendor-notification.js')); ?>"></script>

<?php echo $__env->yieldContent('page-scripts'); ?>
<?php echo $__env->yieldContent('withdraw-scripts'); ?>

</body>
</html>
<?php /**PATH /home/aayancom/public_html/resources/views/vendor/layout/footer/footer.blade.php ENDPATH**/ ?>