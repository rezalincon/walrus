<?php $__env->startSection('content'); ?>
            ...
            <div >
                ...
                <div  class="row">
                    ...
                    <div class=" col-md-6 h-camp">
                       <a href="<?php echo e($link1); ?>"> <img class="mini-banner" src="\storage\storeLogo\<?php echo e($campaign1); ?>" alt="campaign">
                       </a>
                    </div>

                    <div  class="h-camp col-md-6">
                      <a href="<?php echo e($link2); ?>"> <img class="mini-banner" src="\storage\storeLogo\<?php echo e($campaign2); ?>" alt="campaign">
                      </a>
                    </div>
               </div>
 ...
 <div class="title-link-wrapper container appear-animate mt-10 mb-4 ">
                    ...
                    <div class="product text-center">
                        <figure class="product-media">
                            <a href="<?php echo e(route('product.details',[$item->id, Str::slug($item->name)])); ?>">
                                <img class="product-img" src="<?php echo e("/$item->photo"); ?>" alt="Product" >
                                <img class="product-img" src="<?php echo e("/$item->photo"); ?>" alt="Product">
                            </a>
                        ...
                        <div class="product-details">
                            ...
                            <h4 class="product-name"><strong><a class="product-title" href="<?php echo e(route('product.details',[$item->id, Str::slug($item->name)])); ?>"><?php echo e($item->name); ?></a></strong></h4>
                            ...
                            <?php if($item->stock > 0): ?>
                                <a data-id="<?php echo e($item->id); ?>" class="btn btn-block btn-primary btn-cart" href="#"> <i class="fas fa-shopping-cart"></i>&nbsp  Buy Now</a>
                            <?php else: ?>
      ...
      <div  class="container mt-1 pt-2">
        <div class="col-md-12"  >
            <a href="#"><img class="mid-banner" src="<?php echo e("storage/advertise/".(isset($advertise[1])? $advertise[1]->image_file:'')); ?>"></a>
       ...
       <div class="col-md-2 col-sm-4 col-6">
            ...
            <div class="product text-center">
                ...
                <div class="product-details">
                    <h2 class="product-name"><strong><a class="product-title" href="<?php echo e(route('product.details',[$item->id, Str::slug($item->name)])); ?>"><?php echo e($item->name); ?></a></strong></h2>
                    <div class="ratings-container">
                        <div class="ratings-full">
                            <?php if(ceil($item->avg_rating) > 0): ?>
                            <span class="ratings" style="width: 0%;"></span>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $brand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="product-wrap text-center brands-home square bg-white rounded p-3">
                        <a  href="<?php echo e(route('brand.product',[$item->id,Str::slug($item->name)])); ?>">
                            <img class="brand-img" src="<?php echo e("/uploads/brand-images/$item->photo"); ?>" alt="">
                        </a>
...
<div class="container">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-md-2 col-sm-4 col-6 mb-3">
                    <div  class="border bg-white text-center p-4">
                        <div>
                            <a href="<?php echo e(route('categorize.product',[$item->id, Str::slug($item->name)])); ?>"><img class="category-img" src="<?php echo e("/uploads/category-images/$item->photo"); ?>" alt="Category image"></a>
                        </div>
                        <a href="<?php echo e(route('categorize.product',[$item->id, Str::slug($item->name)])); ?>"><h6  class="mt-1 mb-0"><?php echo e($item->name); ?></h6></a>
                    </div>
                </div>
           ...
           <div  class="container mt-1 pt-2">
        <div class="col-md-12" >
            <a href="#"><img class="mid-banner" src="<?php echo e("storage/advertise/".(isset($advertise[0])? $advertise[0]->image_file:'')); ?>"></a>
             <!--<div class="banner-content align-items-center">-->
             <!--    <div class="banner-price-info">-->
             <!--        <div class="discount text-secondary font-weight-bolder ls-25 lh-1">-->
             <!--            <?php echo e(isset($advertise[1])?$advertise[1]->subtitle:''); ?>-->
            ...
            <?php $__empty_2 = true; $__currentLoopData = $shop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                <div  class="col-md-2 col-sm-4 col-6 mb-3">
                    <div class="border bg-white text-center p-4">
                        <div>
                            <a href="<?php echo e(route('shop.product',[$item->id, Str::slug($item->shop_name)])); ?>"><img class="store-img" src="<?php echo e("/uploads/vendors/$item->shop_image"); ?>" alt=""></a>
                        </div>
                        <a href="<?php echo e(route('shop.product',[$item->id, Str::slug($item->shop_name)])); ?>"><h6  class="mt-1 mb-0"><?php echo e($item->shop_name); ?></h6></a>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="vendor-widget-banner">
                    <figure class="vendor-banner">
                        ...
                        <a href="<?php echo e(route('shop.product',[$top->id, Str::slug($top->shop_name)])); ?>">
                            <img class="topseller-img" src="<?php echo e("/uploads/vendors/$top->shop_image"); ?>"/>
                        </a>
                    </figure>
                    <div class="vendor-details">
                        <figure class="vendor-logo">
                            <a href="<?php echo e(route('shop.product',[$top->id, Str::slug($top->shop_name)])); ?>">
                                <img class="topseller-sub" src="<?php echo e("/uploads/vendors/$top->shop_image"); ?>"/>
                            </a>
                        </figure>
    ...
    <div class="modal-content">
      <div class="modal-body" >
        <div class=" d-flex justify-content-center align-items-center">
            ...
            <img class="promo-img" src="<?php echo e(url('storage/storeLogo/'.$pop->file)); ?>" alt="">
            <?php else: ?>
            <P><img class="promo-img" src="<?php echo e(asset('storage/storeLogo/common.jpg')); ?>" alt=""></P>
            <?php endif; ?>
        </div>
      </div>
    </div>
...
<?php echo $__env->make('frontend.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\uc\Downloads\AyyanFInal\resources\views/frontend/main.blade.php ENDPATH**/ ?>