...
<script src="<?php echo e(asset('/backend/assets/bundles/flotscripts.bundle.js')); ?>"></script><!-- flot charts Plugin Js -->
<script src="<?php echo e(asset('/backend/assets/bundles/c3.bundle.js')); ?>"></script>
<script src="<?php echo e(asset('/backend/assets/bundles/apexcharts.bundle.js')); ?>"></script>
<script src="<?php echo e(asset('/backend/assets/bundles/jvectormap.bundle.js')); ?>"></script>
...
<script src="<?php echo e(asset('/backend/assets/vendor/sweetalert/sweetalert.min.js')); ?>"></script><!-- SweetAlert Plugin Js -->
...
<script src="<?php echo e(asset('../backend/js/pages/charts/apex.js')); ?>"></script>
...
<script src="<?php echo e(asset('/backend/assets/vendor/summernote/dist/summernote-bs4.min.js')); ?>"></script>
<script src="<?php echo e(asset('/backend/js/pages/ui/dialogs.js')); ?>"></script>
<script src="<?php echo e(asset('backend/js/pusher.js')); ?>"></script>

<?php echo $__env->yieldContent('page-scripts'); ?>
<?php echo $__env->yieldContent('minimum-withdraw-scripts'); ?>

</body>
</html>
<?php /**PATH /home/aayancom/public_html/resources/views/admin/layout/footer/footer.blade.php ENDPATH**/ ?>