                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="/admin/orders/<?php echo e($order->id); ?>/orderDetails">View Details</a>
                                                <a class="dropdown-item" href="<?php echo e(route('order.invoice',$order->id)); ?>">View Invoice</a>
                                            </div>
                                        </div>
...
<?php echo $__env->make('admin.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/admin/orders/order-view.blade.php ENDPATH**/ ?>