                        ...
                        <tr>
                            <td class="product-thumbnail">
                                <div class="p-relative">
                                    <a href="<?php echo e(route('product.details',[$row->id, Str::slug($row->name)])); ?>">
                                        <figure>
                            ...
                            <td class="wishlist-action">
                                <div class="d-lg-flex">
                                    <a data-id="<?php echo e($row->product_id); ?>" class="btn btn-dark btn-rounded btn-sm ml-lg-2 btn-cart">Add to
                                        cart</a>
                                </div>
                            </td>
                        </tr>
...
<?php echo $__env->make('frontend.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/frontend/wishlist/wishlist.blade.php ENDPATH**/ ?>