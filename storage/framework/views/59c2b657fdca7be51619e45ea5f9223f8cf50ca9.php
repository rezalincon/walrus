...
<div class="row">
    <div class="col-md-12 col-lg-4">
        <div class="card">
            <div class="header">
                <h5 class="card-title"><b>Header Left First</b></h5>
            </div>
            <div class="body">
               <form class="addtext" enctype="multipart/form-data">
                    <input type="hidden" value="left1" name="textType">
                    <input type="text" class="form-control" id="headerText" name="file"  placeholder="Header Left First" value="<?php echo e($left1); ?>" required>
    ...
    <div class="col-md-12 col-lg-4">
        <div class="card">
            <div class="header">
                <h5 class="card-title"><b>Header Left Second</b></h5>
            </div>
            <div class="body">
               <form class="addtext" enctype="multipart/form-data">
                    <input type="hidden" value="left2" name="textType">
                    <input type="text" class="form-control" id="headerText" name="file"  placeholder="Header Left Second" value="<?php echo e($left2); ?>" required>
    ...
    <div class="col-md-12 col-lg-4">
        <div class="card">
            <div class="header">
                <h5 class="card-title"><b>Header Right</b></h5>
            </div>
            <div class="body">
               <form class="addtext" enctype="multipart/form-data">
                    <input type="hidden" value="right" name="textType">
                    <input type="text" class="form-control" id="headerText" name="file"  placeholder="Header Right" value="<?php echo e($right); ?>" required>
...
<?php echo $__env->make('admin.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/admin/setting/headerText.blade.php ENDPATH**/ ?>