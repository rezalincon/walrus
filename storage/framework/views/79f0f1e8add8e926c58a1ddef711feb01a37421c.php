                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover dataTable js-exportable">
                            ...
                            <tr data-id="<?php echo e($row->id); ?>">
                                ...
                                <td>
                                    <select class="theme-bg" name=""  data-id="<?php echo e($row->id); ?>" id="selectStatus">
                                ...
                                <td>
                                    <select class="theme-bg" name=""  data-id="<?php echo e($row->id); ?>" id="isFeatured">
                                        <option value="1" <?php echo e($row->is_featured == 1 ? 'selected' : ''); ?>>Yes</option>
                                        <option value="0" <?php echo e($row->is_featured == 0 ? 'selected' : ''); ?>>No</option>
                                    </select>
                                </td>
                                <td>
                                    <button data-id="<?php echo e($row->id); ?>" data-toggle="modal" data-target="#editCategoryModal" class="btn btn-primary btn-round mr-1 editBtn" style="cursor: pointer" type="button"><i class="fa fa-edit"></i> Edit</button>
...
<?php echo $__env->make('admin.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/admin/category/category-view.blade.php ENDPATH**/ ?>