                        ...
                        <div class="col-md-8 ml-auto mr-auto">
                            <form action="" id="add-brand-form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" aria-label="Default" aria-describedby="inputGroup-sizing-default" placeholder="Enter Brand Name" required>
                                </div>
                        ...
                        <div class="col-md-8 ml-auto mr-auto">
                            <form action="" id="edit-brand-form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="edit-name" name="name" placeholder="Enter Brand Name" aria-label="Default" aria-describedby="inputGroup-sizing-default" required>
                                </div>
...
<?php echo $__env->make('admin.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/admin/brand/brand-view.blade.php ENDPATH**/ ?>