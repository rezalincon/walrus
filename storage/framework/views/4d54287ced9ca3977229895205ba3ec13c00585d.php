        ...
        <?php $__empty_1 = true; $__currentLoopData = $blog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
         <div class="col-lg-4 col-md-6 mb-2-6">
            <article class="card card-style2">
                <div class="card-img">
                    <img class="rounded-top" src="<?php echo e(asset('uploads/blogs/'.$b->image)); ?>" alt="...">
                    <div class="date"></div>
                </div>
                <div class="card-body">
                    <h3 class="h5 text-uppercase"><a href="<?php echo e(route('viewblog',$b->id)); ?>"><h4><?php echo e($b->title); ?></h4></a></h3>
                    <p class="">  <?php echo Str::limit($b->details, 100); ?></p>
                    <a href="<?php echo e(route('viewblog',$b->id)); ?>" class="read-more text-capitalize">read more</a>
                </div>
                <div class="card-footer">
                    <ul>

                        <li><a href="#!"><i class="far fa-clock"></i><span><?php echo e($b->created_at->format('d-m-Y')); ?></span></a></li>
                    </ul>
                </div>
            </article>
        </div>
...
<?php echo $__env->make('frontend.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/frontend/blogs/index.blade.php ENDPATH**/ ?>