 ...
 <span class="emoji"><i style="color:#16C60C" class="fas fa-check-circle"></i></span> 
  ...
  <div id="confetti-wrapper">
                    ...
                    <ul class="order-view list-style-none">
                        ...
                        <li class="shadow">
                            <label>Total</label>
                            <strong><?php echo e(($orders[0]->order->payment_method == "cash on") ?
                                "Cash On Delivery" : "Paid"); ?></strong>
                        </li>
                        <li class="shadow">
...
<?php echo $__env->make('frontend.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/frontend/order_complete.blade.php ENDPATH**/ ?>