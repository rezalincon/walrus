...
<div class="row row-cards-one">
    ...
    <div class="col-md-12 col-lg-6 col-xl-4">
        <div class="mycard bg2">
            <div style="z-index:7" class="left">
                <h5 class="title">Orders On Delivery! </h5>
    ...
    <span class="number"><?php echo e($total->where('vendor_id',Auth::user()->id)->count()); ?></span>
    </div>
    </div>
    </div>
...
<?php echo $__env->make('vendor.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/vendor/dashboard/index.blade.php ENDPATH**/ ?>