                    ...
                    <table class="table table-striped table-hover dataTable js-exportable">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $others; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $other): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php if($other->min_withdraw_amount != 0): ?>
                                <tr id="data-id" data-id="<?php echo e($other->id); ?>">
                                    <td id="id"><?php echo e($other->id); ?></td>
                                    <td id="amount"><?php echo e($other->min_withdraw_amount); ?></td>
                                </tr>
                                <?php endif; ?>
...
<?php $__env->startSection('minimum-withdraw-scripts'); ?>
    ...
    <script src="<?php echo e(asset('/backend/js/minimum-withdraw.js')); ?>"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/admin/setting/minimum-withdraw.blade.php ENDPATH**/ ?>