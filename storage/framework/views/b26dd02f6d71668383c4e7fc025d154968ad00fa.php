        ...
        <div class="container bg-white p-5">
            <div class="row justify-content-center">
                <div class="row col-md-8 shadow">
                    ...
                    <span class="font-size-md"> Already have an account? </span> <a class="mb-4 text-primary font-size-md" href="<?php echo e(route('customer.login')); ?>"> Login </a>
                    </div>
                            ...
                            <div class="tab-pane" id="sign-up">
                                ...
                                <form  method="post" id="registerForm" >
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input placeholder="Enter mobile no" type="text" id="reg_phone" class="form-control" name="phone"  value="<?php echo e(old('phone')); ?>" required>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="password" id="reg_password_confirmation" class="form-control" name="password_confirmation" value="<?php echo e(old('password_confirmation')); ?>" placeholder="Confirm Password" required>
                                    </div>
                                    <div class="tacbox">
                                    ...
                                    <a id="register" href="#" type="submit" class="btn btn-primary my-4">Sign Up</a>
                                     <span id="m-log" class="font-size-md"> Already have an account?  <a class="mb-4 text-primary font-size-md" href="<?php echo e(route('customer.login')); ?>"> Login </a></span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\uc\Downloads\AyyanFInal\resources\views/frontend/auth/register.blade.php ENDPATH**/ ?>