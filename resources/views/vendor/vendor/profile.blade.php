        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head">
                    <div class="profile mr-3"><img src="/uploads/vendors/{{$vendor->image}}" alt="..." width="130" class="rounded mb-2 img-thumbnail">
                        <a style="margin-left:auto;" href="{{route('vendor.profile')}}" class="btn btn-outline-dark btn-sm btn-block">Edit profile</a>
                    </div>
                
                    <div class="media-body mb-5 text-white">
                        <h4 class="mt-0 mb-0">{{old('shopname',$vendor->shop_name)}}</h4>
                        <p class="small mb-4"> <i class="fa fa-map-marker-alt mr-2 text-white"></i>{{$vendor->address}}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="px-4 py-3 mt-3">
                ...
                <div class="p-4 rounded shadow-sm bg-light">
                    ...
                    <td>{{old('shopname',$vendor->shop_name)}}</td>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                    ...
                    <td>{{old('name',$vendor->name)}}</td>
                    
                    </tr>
                      <tr>
                    <th scope="row">Owner Email</th>
                    <td>{{old('email',$vendor->email)}}</td>
                    ...
                    <div class="col-md-8 ml-auto mr-auto">
                        <form action="" id="edit-vendor-form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="email" class="form-control" id="edit-email" name="email" placeholder="Enter email" value="{{old('email',$vendor->email)}}" aria-label="Default" aria-describedby="inputGroup-sizing-default" required>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" class="form-control" id="edit-phone" name="phone" placeholder="Enter phone number" value="{{old('phone',$vendor->phone)}}" aria-label="Default" aria-describedby="inputGroup-sizing-default" >
                            </div>
