                ...
                <div class="d-flex align-items-center justify-content-lg-end mt-4 mt-lg-0 flex-wrap vivify pullUp delay-550">
                   <?php if($profit->isNotEmpty()): ?>
                    <div class="border-right pr-4 mr-4 mb-2 mb-xl-0 hidden-xs">
                        <p class="text-muted mb-1">Product Sell <span id="mini-bar-chart3" class="mini-bar-chart"></span></p>
                        <h5 class="mb-0"><?php echo e($profit->where('status','Completed')->sum('qty')); ?></h5>
                    </div>

                    <div class="border-right pr-4 mr-4 mb-2 mb-xl-0">
                        <p class="text-muted mb-1">Total Sell Amount<span id="mini-bar-chart1" class="mini-bar-chart"></span></p>
                     ...
                     <div class="border-right pr-4 mr-4 mb-2 mb-xl-0">
                        <p class="text-muted mb-1">Total Amount After Withdraw Complete<span id="mini-bar-chart4" class="mini-bar-chart"></span></p>
                        <h5 class="mb-0"><?php echo e($order_o[0]->where('status','Completed')->sum('subtotal')-($data['withdraw']->where('status','Completed')->sum('amount'))); ?></h5>
                    </div>
                    <div class="border-right pr-4 mr-4 mb-2 mb-xl-0">
                                    ...
                                    <div id="slider1" class="carousel vert slide" data-ride="carousel" data-interval="2700">
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item active">
                                                <div>Total Sell</div>
                                                <div class="mt-3 h1"><?php echo e($order_o[0]->where('status','Completed')->sum('subtotal')); ?></div>
                                            </div>
                                            <div class="carousel-item">
                                                <div>Total Product Sell</div>
                                                <div class="mt-3 h1"><?php echo e($profit->where('status','Completed')->sum('qty')); ?></div>
                                            </div>
                                            <div class="carousel-item">
                                                <div>Total Profit</div>
                                                <div class="mt-3 h1"><?php echo e($profit->where('status','Completed')->sum('profit')); ?></div>
                                            </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div id="slider3" class="carousel vert slide" data-ride="carousel" data-interval="3000">
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item active">
                                                ...
                                                <div class="mt-3 h1"><?php echo e(isset($profit[0]->order) ? $profit[0]->order->where('status','=','Completed')->count() : 0); ?> </div>

                                            </div>
                                            <div class="carousel-item">
                                                <div>Order Pending</div>
                                                <div class="mt-3 h1"><?php echo e(isset($profit[0]->order) ? $profit[0]->order->where('status','=','Pending')->count() : 0); ?></div>
                                            </div>
                                            <div class="carousel-item">
                                                <div>Order Declined</div>
                                                <div class="mt-3 h1"><?php echo e(isset($profit[0]->order) ? $profit[0]->order->where('status','=','Declined')->count() : 0); ?></div>
                                            </div>
                                            <div class="carousel-item">
                                                <div>Total Number of Order</div>
                                                <div class="mt-3 h1"><?php echo e(isset($profit[0]->order) ? $profit[0]->order->count() : 0); ?></div>
                                    ...
                                    <div id="slider4" class="carousel vert slide" data-ride="carousel" data-interval="2500">
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item">
                                                ...
                                                <div class="mt-3 h1"><?php echo e(isset($data['withdraw']) ? $data['withdraw']->where('status','=','Completed')->count() : 0); ?></div>
                                            </div>
                                            <div class="carousel-item">
                                                <div>Withdraw Pending</div>
                                                <div class="mt-3 h1"><?php echo e(isset($data['withdraw']) ? $data['withdraw']->where('status','=','Pending')->count() : 0); ?></div>
                                            </div>
        ...
        <div class="col-12">
            <div class="row clearfix">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card bg1">
                        <div class="body">
                            ...
                            <h3 class="mb-1"><?php echo e($data['withdraw']->where('status','=','Pending')->count()); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card bg1">
                        <div class="body">
                            ...
                            <h3 class="mb-1"><?php echo e($data['withdraw']->where('status','=','Processing')->count()); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card bg1">
                        <div class="body">
                            ...
                            <h3 class="mb-1"><?php echo e($data['withdraw']->where('status','=','Completed')->count()); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card bg1">
                        <div class="body">
                            ...
                            <h3 class="mb-1"><?php echo e($data['withdraw']->where('status','=','Declined')->count()); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-6 col-sm-12">
                    <div class="card theme-bg gradient text-light">
                        <div class="body">
                            ...
                            <h3 class="mb-1"><?php echo e($data['order_processing']); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-2 col-md-6 col-sm-12">
                ...
                <div class="col-lg-2 col-md-6 col-sm-12">
                    <div class="card theme-bg gradient text-light">
                        <div class="body">
                            ...
                            <h3 class="mb-1"><?php echo e($data['order_onDelivery']); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-2 col-md-6 col-sm-12">
                ...
                <div class="col-lg-2 col-md-6 col-sm-12">
                    <div class="card theme-bg gradient text-light">
                        <div class="body">
                            <div><strong>Total <br> Order</strong></div>
                    ...
                    <table class="table table-striped mb-0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo e(route('order.details', $row->id)); ?>" class="btn btn-primary btn-round mr-1 editBtn" style="cursor: pointer" type="button"> view </a></td>
                            </tr>
                    ...
                    <table class="table table-striped mb-0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($row->created_at->format('d-m-Y')); ?></td>
                                <td><a href="<?php echo e(route('customerShow')); ?>" class="btn btn-primary btn-round mr-1 editBtn" style="cursor: pointer" type="button"> view </a></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
                    ...
                    <table class="table table-striped mb-0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo e(route('productView', $row->id)); ?>" class="btn btn-primary btn-round mr-1 editBtn" style="cursor: pointer" type="button"> view </a></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
...
<?php echo $__env->make('admin.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/admin/dashboard/dashboard.blade.php ENDPATH**/ ?>