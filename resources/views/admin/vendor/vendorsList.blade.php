                            ...
                            <tbody>
                                ...
                                @forelse($vendors as $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->name }}</td>
                                        <td>{{ $row->email }}
                                        <input type="hidden" name="email" value="{{ $row->email }}"></td>
                                        <td>{{ $row->phone }}</td>
                                        <td>{{ $row->shop_name }}</td>
                                        <td>{{ $row->address }}</td>
...
<!--{{--                                            </select>--}}-->
                                        ...
                                        <td>
                                            <span data-id="{{ $row->id }}"
                                                  ...
                                                  style="cursor: pointer"
                                            >{{ $row->s_status == 1 ? 'ACTIVE' : 'DEACTIVE' }}</span>
<!--{{--                                            <select name="" class="theme-bg" data-id="{{ $row->id }}"--}}-->
<!--{{--                                                id="selectStatus">--}}-->
<!--{{--                                                <option value="1" {{ $row->s_status == 1 ? 'selected' : '' }}>Active</option>--}}-->
<!--{{--                                                <option value="0" {{ $row->s_status == 0 ? 'selected' : '' }}>De-active</option>--}}-->
<!--{{--                                            </select>--}}-->
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <button data-id="{{$row->id}}" data-toggle="modal" id="email" data-target="#emailModal" class="btn btn-warning btn-round mr-1 editBtn" style="cursor: pointer" type="button"><i class="fa fa-edit"></i> Email</button>
