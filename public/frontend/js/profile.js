$(function(){
    ...
    $('#account-details-edit').on('click', function(){
        $('#account-details-form').attr('hidden', false);
        $('#account-details-table').attr('hidden', true);
        $('#account-details-edit').attr('hidden', true);
    });
    $('#cancel').on('click', function(event){
        event.preventDefault();
        $(window).scrollTop(10);
        $('#account-details-form').attr('hidden', true);
        $('#account-details-table').attr('hidden', false);
        $('#account-details-edit').attr('hidden', false);
    });
});
