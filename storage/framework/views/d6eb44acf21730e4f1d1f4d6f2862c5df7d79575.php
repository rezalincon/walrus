                ...
                <div class="body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                            <?php if($pixel): ?>
                                <tr data-id="<?php echo e($pixel->id); ?>">
                                    <td><?php echo e($pixel->facebook_account_name); ?></td>
                                    <td><?php echo e($pixel->pixel_name); ?></td>
...
<?php $__env->startSection('page-scripts'); ?>
    ...
    <script src="<?php echo e(asset('/backend/js/pixel.js')); ?>"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/admin/pixel/pixel-view.blade.php ENDPATH**/ ?>