...
class SettingController extends Controller
{
    ...
    public function logo()
    {
        ...
        //return $header;
        return view('admin.setting.logo-view',['header'=>$header,'footer'=>$footer,'invoice'=>$invoice,'sidebar'=>$sidebar,'barText'=>$barText]);
    }
    ...
    public function headerText()
    {
        ...
        return view('admin.setting.headerText',['left1'=>$left1,'left2'=>$left2,'right'=>$right]);
    }
    ...
    public function storeSlider(Request $request)
    {
        ...
        //     $request->photo->move('storage/storeSliders/',$filename);
        //     $slider->image_file=$filename;
        // }
        // if ($request->hasFile('b_photo')){
        //     $extension = $request->b_photo->getClientOriginalExtension();
        //     $filename = rand(10000,99999).time().'.'.$extension;
        //     $request->b_photo->move('storage/storeSliders/',$filename);
        ...
        // $slider->text_position = $request->position;
        $slider->save();
    ...
    public function updateSlider(Request $request, Slider $slider)
    {
       // return $request;
        ...
        // if ($request->hasFile('b_photo')){
        //     unlink('storage/storeSliders/'.$slider->background_image);
        //     $extension = $request->b_photo->getClientOriginalExtension();
        //     $filename = rand(10000,99999).time().'.'.$extension;
        //     $request->b_photo->move('storage/storeSliders/',$filename);
        //     $slider->background_image = $filename;
