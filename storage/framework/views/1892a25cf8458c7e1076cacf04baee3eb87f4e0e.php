<div id="left-sidebar" class="sidebar">
    ...
    <div class="sidebar-scroll">
        <div class="user-account">
            <div class="user_div">
                <img src="<?php echo e((!empty(Auth::user()->image))?url('uploads/vendors/'.Auth::user()->image):url('/backend/assets/user.png')); ?>"  class="user-photo" alt="Profile Picture">
            </div>
            <div class="dropdown">
                <span>Vendor</span>
...
<?php /**PATH /home/aayancom/public_html/resources/views/vendor/layout/header/left-sidebar.blade.php ENDPATH**/ ?>