...
<body>
    ...
    <div id="body" class="theme-cyan">
        ...
        <div class="themesetting">
            ...
            <hr>
            <div>
                <a href="#"  class="btn btn-primary theme-bg gradient btn-block">Change Outlook</a>
            </div>
        </div>
        ...
        <div id="wrapper">
<?php /**PATH /home/aayancom/public_html/resources/views/vendor/layout/header/head.blade.php ENDPATH**/ ?>