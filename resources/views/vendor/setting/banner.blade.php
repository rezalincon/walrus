        ...
        <div class="card">
            ...
            <div class="body">
               <form class="addLogo" enctype="multipart/form-data">
                    ...
                    <input type="file" class="dropify" data-allowed-file-extensions="png jpg jpeg" name="file"  data-default-file="\uploads\vendors\{{$logo}}">
                    <br>
                    <br>
        ...
        <div class="card">
            ...
            <div class="body">
               <form class="addBanner" enctype="multipart/form-data">
                    <input type="hidden" value="{{$id}}" name="id" id="id">
                    <input type="file" class="dropify" data-allowed-file-extensions="png jpg jpeg" name="file"  data-default-file="\storage\storeFavicon\{{$data}}">
                    <br>
                    <br>
                    <input class="btn btn-primary" type="submit" value="Submit">
                </form>
