...
@endif
                                    ...
                                    <div id="slider1" class="carousel vert slide" data-ride="carousel" data-interval="2700">
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item active">
                                                <div>Total Sell</div>
                                                <div class="mt-3 h1">{{$order_o[0]->where('status','Completed')->sum('subtotal')}}</div>
                                            </div>
                                            <div class="carousel-item">
                                                <div>Total Product Sell</div>
                                                <div class="mt-3 h1">{{$profit->where('status','Completed')->sum('qty')}}</div>
                                            </div>
                                            <div class="carousel-item">
                                                <div>Total Profit</div>
                                                <div class="mt-3 h1">{{$profit->where('status','Completed')->sum('profit')}}</div>
                                            </div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div id="slider2" class="carousel vert slide" data-ride="carousel" data-interval="2800">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                ...
                                                <div class="mt-3 h1">{{$vendor}}</div>
                                            </div>
                                            <div class="carousel-item">
                                                <div>Total Customer</div>
                                                <div class="mt-3 h1">{{$user}}</div>
                                            </div>
                                            <div class="carousel-item">
                                                <div>Total Admin</div>
                                                <div class="mt-3 h1">{{$admin}}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div id="slider3" class="carousel vert slide" data-ride="carousel" data-interval="3000">
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item active">
                                                ...
                                                <div class="mt-3 h1">{{$profit[0]->order->where('status','=','Completed')->count()}}</div>

                                            </div>
                                            <div class="carousel-item">
                                                <div>Order Pending</div>
                                                <div class="mt-3 h1">{{$profit[0]->order->where('status','=','Pending')->count()}}</div>
                                            </div>
                                            <div class="carousel-item">
                                                <div>Order Declined</div>
                                                <div class="mt-3 h1">{{$profit[0]->order->where('status','=','Declined')->count()}}</div>
                                            </div>
                                            <div class="carousel-item">
                                                <div>Total Number of Order</div>
                                                <div class="mt-3 h1">{{$profit[0]->order->count()}}</div>
                                    ...
                                    <div id="slider4" class="carousel vert slide" data-ride="carousel" data-interval="2500">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                ...
                                                <div class="mt-3 h1">{{$brand}}</div>
                                            </div>
                                            <div class="carousel-item">
                                                <div>Withdraw Completed</div>
                                                <div class="mt-3 h1">{{$data['withdraw']->where('status','=','Completed')->count()}}</div>
                                            </div>
                                            <div class="carousel-item">
                                                <div>Withdraw Pending</div>
                                                <div class="mt-3 h1">{{$data['withdraw']->where('status','=','Pending')->count()}}</div>
                                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card bg1">
                        <div class="body">
                            ...
                            <h3 class="mb-1">{{$data['withdraw']->where('status','=','Pending')->count()}}</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card bg1">
                        <div class="body">
                            ...
                            <h3 class="mb-1">{{$data['withdraw']->where('status','=','Processing')->count()}}</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card bg1">
                        <div class="body">
                            ...
                            <h3 class="mb-1">{{$data['withdraw']->where('status','=','Completed')->count()}}</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card bg1">
                        <div class="body">
                            ...
                            <h3 class="mb-1">{{$data['withdraw']->where('status','=','Declined')->count()}}</h3>
                        </div>
                    </div>
                </div>
    ...
    <div class="row clearfix row-deck">
                    ...
                    <table class="table table-striped mb-0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('order.details', $row->id)}}" class="btn btn-primary btn-round mr-1 editBtn" style="cursor: pointer" type="button"> view </a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                <div class="body">
                    <table class="table table-striped mb-0">
                        <tbody>
                            ...
                            @foreach($data['new_customers'] as $row)
                            <tr>
                                <td>{{$row->name}}</td>
                                <td>{{$row->created_at->format('d-m-Y')}}</td>
                                <td><a href="{{route('customerShow')}}" class="btn btn-primary btn-round mr-1 editBtn" style="cursor: pointer" type="button"> view </a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="header">
                    <h2><strong>Top {{$data['tsp']->count()}} selling products of last 7 days</strong></h2>
                </div>
                <div class="body">
                    <table class="table table-striped mb-0">
                        <tbody>
                            ...
                            @foreach($data['tsp'] as $row)
                            <tr>
                                <td>{{$row->id}}</td>
                                <td>{{$row->name}}</td>
                                <td>{{$row->categories->name}}</td>
                                <td>{{$row->brand ? $row->brand->name : null}}</td>
                                <td>{{$row->vendor ? $row->vendor->name : null}}</td>
                                <td>{{$row->stock}}</td>
                                <td><a href="{{route('productView', $row->id)}}" class="btn btn-primary btn-round mr-1 editBtn" style="cursor: pointer" type="button"> view </a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="header">
                    <h2><strong>Top {{$data['top_vendor']->count()}} vendors of last 7 days</strong></h2>
                </div>
                <div class="body">
                    <table class="table table-striped mb-0">
                        <tbody>
                            ...
                            @foreach($data['top_vendor'] as $row)
                            <tr>
                                <td>{{$row->id}}</td>
                                <td>{{$row->name}}</td>
                                <td>{{$row->shop_name}}</td>
