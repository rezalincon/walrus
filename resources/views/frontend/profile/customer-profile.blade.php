                ...
                <div class="container">
                    <div class="tab tab-vertical row gutter-lg">
                        <ul class="nav nav-tabs mb-6" role="tablist">
                            ...
                            {{--<li class="nav-item">
                                <a href="{{route('wishlist.view', Auth::id())}}" class="nav-link">Wishlist</a>
                            </li>--}}
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('customer.logout') }}" onclick="event.preventDefault();
                        ...
                        <div class="tab-content mb-6">
                            <div class="tab-pane active in" id="account-dashboard">
                                <p class="greeting">
                                    ...
                                    (not
                                    <span class="text-dark font-weight-bold">{{ Auth::user()->name }}</span>?
                                    <a href="{{route('customer.logout')}}" class="text-primary"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> Log out
                                    </a>)
                                </p>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="order-total">
                                                ...
                                                <span class="order-quantity">{{$order->orderProduct->sum('qty')}}</span> item
                                            </td>
                            ...
                            <div class="tab-pane" id="account-details">
                                ...
                                <form class="form account-details-form" method="post" id="account-details-form" hidden>
                                    ...
                                    <div class="form-group mb-6">
                                        ...
                                        <input type="email" id="user-email" name="email" value="{{old('email', Auth::user()->email)}}"
                                            class="form-control form-control-md">
                                    </div>
