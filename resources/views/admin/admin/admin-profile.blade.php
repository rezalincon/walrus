                ...
                <div class="row">
                    <div class="col-md-8 ml-auto mr-auto mb-3">
                        ...
                        <form action="" id="edit-admin-form" method="post" enctype="multipart/form-data">
                            ...
                            <!--    </div>-->
                            <!--    <input type="text" class="form-control" id="edit-name" name="name" value="{{old('name',$admin->name)}}" aria-label="Default" aria-describedby="inputGroup-sizing-default" required>-->
                            <!--</div>-->
                            ...
                            <!--    </div>-->
                            <!--    <input type="email" class="form-control" id="edit-email" name="email" value="{{old('email',$admin->email)}}" aria-label="Default" aria-describedby="inputGroup-sizing-default" required>-->
                            <!--</div>-->
                            ...
                            <!--    </div>-->
                            <!--    <input type="text" class="form-control" id="edit-phone" name="phone" value="{{old('phone',$admin->phone)}}" aria-label="Default" aria-describedby="inputGroup-sizing-default" >-->
                            <!--</div>-->
