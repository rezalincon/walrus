                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($row->name); ?><br></small> <small>SKU:
                                        <?php echo e($row->sku); ?></small> <small>Shop: <?php echo e(isset($row->vendor->shop_name) ? $row->vendor->shop_name : ''); ?> </small></td>
                                        ...
                                        <td>
                                            <select class="theme-bg"  data-id="<?php echo e($row->id); ?>" id="selectIsFeatured">
                                                <option class="text-dark" value="1" <?php echo e($row->featured == 1 ? 'selected' : ''); ?>>Yes</option>
                                                <option value="0" <?php echo e($row->featured == 0 ? 'selected' : ''); ?>>No</option>
                                            </select>
                                        </td>
                                        <td>
                                            ...
                                            <a  href="<?php echo e(route('productDelete', $row->id)); ?>"
...
<?php echo $__env->make('admin.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/admin/product/allProducts.blade.php ENDPATH**/ ?>