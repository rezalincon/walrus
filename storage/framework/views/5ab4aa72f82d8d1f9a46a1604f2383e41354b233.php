                    ...
                    <div class="col-md-8 ml-auto mr-auto">
                        <form action="" id="edit-vendor-form" method="post" enctype="multipart/form-data">
                           ...
                           <div class="form-group row">
                            ...
                            <!--    </div>-->
                            <!--    <input type="email" class="form-control" id="edit-email" name="email" placeholder="Enter email" value="<?php echo e(old('email',$vendor->email)); ?>" readonly aria-label="Default" aria-describedby="inputGroup-sizing-default" required>-->
                            <!--</div>-->
                            ...
                            <!--    </div>-->
                            <!--    <input type="number" class="form-control" id="edit-phone" name="phone" placeholder="Enter phone number" readonly value="<?php echo e(old('phone',$vendor->phone)); ?>" aria-label="Default" aria-describedby="inputGroup-sizing-default" >-->
                            <!--</div>-->
...
<?php echo $__env->make('vendor.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/vendor/vendor/vendor-profile.blade.php ENDPATH**/ ?>