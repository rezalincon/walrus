            ...
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head">
                    <div class="profile mr-3"><img src="/uploads/vendors/<?php echo e($vendor->image); ?>" alt="..." width="130" class="rounded mb-2 img-thumbnail">
                        <a style="margin-left:auto;" href="<?php echo e(route('vendor.profile')); ?>" class="btn btn-outline-dark btn-sm btn-block">Edit profile</a>
                    </div>
...
<?php echo $__env->make('vendor.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/vendor/vendor/profile.blade.php ENDPATH**/ ?>