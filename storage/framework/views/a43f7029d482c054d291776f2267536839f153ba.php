        ...
        <div class="card">
            ...
            <div class="body">
               <form class="addLogo" enctype="multipart/form-data">
                    ...
                    <input type="file" class="dropify" data-allowed-file-extensions="png jpg jpeg" name="file"  data-default-file="\uploads\vendors\<?php echo e($logo); ?>">
                    <br>
                    <br>
...
<?php echo $__env->make('vendor.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/vendor/setting/banner.blade.php ENDPATH**/ ?>