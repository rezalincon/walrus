                        ...
                        <table class="table table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                @forelse($products as $row)
                                    <tr>
                                        <td>{{ $row->id}}</td>
                                        <td>{{ $row->name }}<br></small> <small>SKU:
                                        {{ $row->sku }}</small> <small>Shop: {{isset($row->vendor->shop_name) ? $row->vendor->shop_name : '' }} </small></td>
                                        <td>{{ $row->stock }}</td>
                                        <td>{{ $row->price }}</td>
                                        ...
                                        <td>
                                            <select class="theme-bg"  data-id="{{$row->id}}" id="selectIsFeatured">
                                                <option class="text-dark" value="1" {{$row->featured == 1 ? 'selected' : ''}}>Yes</option>
