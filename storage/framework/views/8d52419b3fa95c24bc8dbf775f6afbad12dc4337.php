...
<?php $__env->startSection('main-content'); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <!-- <a href="<?php echo e(route('sub_menu')); ?>" style="float: right;" class=" ml-0 font-weight-bold text-primary ">Sub Menu Add
                    ...
                    <table  class="table table-striped table-bordered  dataTable js-exportable" style="width:100%">
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-id="<?php echo e($data->id); ?>">
                                ...
                                <td><?php echo e($data->sub_menu); ?></td>
                                <td><?php echo e($data->sub_status); ?></td>
                                <td>
                                    <button type="button" data-toggle="modal" data-target="#edit-submenu" data-id="<?php echo e($data->id); ?>" style="cursor: pointer" class="btn btn-primary btn-round mr-1 editBtn">
                                        <i class="fa fa-pencil" aria-hidden="true"></i></button>
                                    <button data-id="<?php echo e($data->id); ?>" class="btn btn-danger btn-round Btn_delete" style="cursor: pointer" type="submit"><i class="fa fa-trash"></i></button>
                                </td>
...
<?php echo $__env->make('admin.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/admin/footer_menu/sub_menu.blade.php ENDPATH**/ ?>