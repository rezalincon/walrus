...
<div class="row clearfix">
            ...
            <div class="body">
                <div class="table-responsive">
                    <table class="table table-striped table-hover dataTable js-exportable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data['withdraws']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
    ...
    <div style="width:80%;overflow-y:auto" class="modal ml-5 fade bd-example-modal-md" tabindex="-1" id="withdrawModal" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        ...
                        <label class="control-label" for="name"><h4> <span id="curr_bal"><strong>Current Balance :</strong> <?php echo e($data['current_bal']); ?></span></h4> </label>
...
<?php $__env->stopSection(); ?>
<?php $__env->startSection('withdraw-scripts'); ?>
    <script src="<?php echo e(asset('/vendor/js/withdraw.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('vendor.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/vendor/withdraws/withdraw.blade.php ENDPATH**/ ?>