                ...
                <div class="body">
                    <div class="row my-3">
                        ...
                        <div class="col-md-4 d-flex flex-row-reverse">
                            <a href="<?php echo e(route('vendor.addproduct')); ?>" class="btn btn-primary theme-bg gradient btn-round"><i
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-<?php echo e($row->status == 1 ? 'warning' : 'danger'); ?> text-white">
                                                <?php echo e($row->status == 1 ? 'Active' : 'Deactive'); ?></span>
                                        </td>
                                        <td>
                                            
                                            <a  href="<?php echo e(route('vendor.productEdit', $row->id)); ?>"
                                                class="btn btn-primary btn-round deleteBtn" style="cursor: pointer"
                                                type="submit"><i class="fa fa-edit"></i> Edit</a>
                                            <a  href="<?php echo e(route('vendor.productDelete', $row->id)); ?>"
                                                class="btn btn-danger btn-round deleteBtn" style="cursor: pointer"
                                                type="submit"><i class="fa fa-trash"></i></a>

                                            <a href="<?php echo e(route('vendor.productView', $row->id)); ?>"
...
<?php echo $__env->make('vendor.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/vendor/product/allProducts.blade.php ENDPATH**/ ?>