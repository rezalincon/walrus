    ...
    <div class="card-body">
        <form class="addFooter">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                    <div class="tawk-area">
                        <textarea class="input-field" name="footer" required="" placeholder="Footer Text *"><?php echo e($data ?$data->footer:''); ?></textarea>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                    <div class="tawk-area">
                        <textarea class="summernote" name="copyright" required=""  placeholder="Copyright Text *"><?php echo e($data ?$data->copyright:''); ?></textarea>
...
<?php echo $__env->make('admin.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/admin/setting/footer-view.blade.php ENDPATH**/ ?>