                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover dataTable js-exportable">
                            ...
                            <tr data-id="<?php echo e($row->id); ?>">
                                ...
                                <td>
                                    <?php if($row->image): ?>
                                        <img style="width: 80px; height: 90px" src="<?php echo e(asset('uploads/admins/'.$row->image)); ?>" alt="admin image">
                                    <?php endif; ?>
                                </td>
 
                                <td>
                                    <button data-id="<?php echo e($row->id); ?>" data-toggle="modal" data-target="#editAdminModal" class="btn btn-primary btn-round mr-1 editBtn" style="cursor: pointer" type="button"><i class="fa fa-edit"></i> Edit</button>
...
<?php echo $__env->make('admin.layout.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aayancom/public_html/resources/views/admin/admin/admin-view.blade.php ENDPATH**/ ?>