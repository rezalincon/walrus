            ...
            <div class="container  p-3">
                <div class="header-left mt-2">
                    ...
                    <div class="ml-5">
                        ...
                        ?>
                        <?php if($left1): ?>
                        <a class="h-anchor" href="#"><i class="fas h-icon fa-phone-volume"></i> <?php echo e($left1->text); ?></a>
                        <?php else: ?>
                    ...
                    <?php
                        ...
                        ?>
                        <?php if($left2): ?>
                        <a class="h-anchor a-space"  href="#"><i class="fas h-icon fa-headset"></i> <?php echo e($left2->text); ?></a>
                        <?php else: ?>
                ...
                <div class="header-right">
                    ...
                    <?php
                        ...
                        ?>
                        <?php if($right): ?>
                        <a class="h-anchor" href="#"><i class="fas h-icon fa-tablet-alt"></i> <?php echo e($right->text); ?></a>
                        <?php else: ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="Minumum 8 characters"
                                                    ...
                                                    <span class="font-size-md"> Don't have an account? </span> <a class="mb-4 font-size-md u-sign" href="<?php echo e(route('customer.register')); ?>"><u>Sing up</u></a>
...
<?php /**PATH C:\Users\uc\Downloads\AyyanFInal\resources\views/components/frontend/header.blade.php ENDPATH**/ ?>